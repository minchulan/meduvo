...
//   const filteredAppointments = categoryFilter ? appointments.filter((appointment) => appointment.category.toLowerCase() === categoryFilter.toLowerCase()) : appointments;
  
//   const goBack = () => navigate("/");
  
//   if (!appointments) <div>Loading appointments...</div>;
